...
function DeptCard({ code, name, actual, headcount, color }: {
  code: string; name: string; actual: number; headcount: number; color: string;
}) {
  return (
    <div
                    ...
                    <div className="flex justify-center gap-2 flex-wrap">
                      {depts.map((dept) => (
                        <div key={dept.id} className="flex flex-col items-center">
                          <ConnectorLine vertical />
                          <DeptCard code={dept.code} name={dept.name} actual={dept.actual} headcount={dept.headcount} color={color} />
                        </div>
                      ))}
                    </div>
                  </div>
